    ...
    <main style="max-width: 700px; margin: 1em auto; background-color: white; box-shadow: 0px 0px 20px  lightgray; padding: 3em;">
      ...
      <div class="footer" style="margin: 1.4em 0; margin-top: 100px; opacity: 0.5; font-size: 0.8em;">
        <div style="margin: 1.4em 0;">
          This email was intended for ${user.firstName + ' ' + user.lastName}  (${user.email}). If you received this by mistake or have any questions, please reach out to us on
          support@xpsq.com.
        </div>
  
        <div style="margin: 1.4em 0;">XPSQ Nigeria</div>
      </div>
    </main>
  </body>
  </html>
